...
async def run_single_browser(**kwargs):
    ...
    async with async_playwright() as playwright:
        ...
        print(f"等待发布完成{browser_id},视频路径【{video_path}】,视频文案【{copy_content}】")
        time.sleep(2)
        closeBrowser(browser_id)
if __name__ == "__main__":
    kwargs = {
        "pad_code": "39712a6b6707475a84f9120fcf1e277e",
        "video_path": r"\\192.168.1.3\x9产品资料库\推广视频\去重\20251230\2.mp4",
        "copy_content": "missing 1 required positional argument"
    }
    asyncio.run(run_single_browser(**kwargs))